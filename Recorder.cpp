...
BOOL CRecorderApp::InitInstance()
{
	...
	//创建互斥量
	m_hUniqueMutex = ::CreateMutexA(NULL,FALSE,_T("Recorder_V1.0"));
	//判断互斥量是否存在
	if(GetLastError() == ERROR_ALREADY_EXISTS)
	{
		AfxMessageBox(_T("Recorder V1.0 已经在运行中！"));
		return false;
	}
	else
	{
	...
	m_pMainWnd->SetWindowText(_T("海道普瞬态记录仪-V1.0"));
	
	//首先进行卡的检测
	
    CRecorderDoc* pDoc = (CRecorderDoc*)((CMainFrame*)m_pMainWnd)->GetActiveDocument();
	pDoc->m_Product.ChechCard();
//	pDoc->m_Product.Initialize();
...
/////////////////////////////////////////////////////////////////////////////
// CRecorderApp message handlers


int CRecorderApp::ExitInstance() 
{
	// TODO: Add your specialized code here and/or call the base class
	if(m_hUniqueMutex != NULL)
	{
		CloseHandle(m_hUniqueMutex);	//关闭句柄
	}
